...
yaml_emitter_dump(yaml_emitter_t *emitter, yaml_document_t *document)
{
    ...
    emitter->anchors = static_cast<yaml_emitter_s::Anchors*>(yaml_malloc(sizeof(*(emitter->anchors))
...
yaml_emitter_generate_anchor(yaml_emitter_t *emitter, int anchor_id)
{
    yaml_char_t *anchor = static_cast<yaml_char_t*>(yaml_malloc(ANCHOR_TEMPLATE_LENGTH));
